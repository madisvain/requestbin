...
class TestBinsApi(TestBase):
    ...
    def test_list_authorization(self):
        ...
        b1 = Bin.create(session=session1, name="random 1")
        b2 = Bin.create(session=session2, name="random 2")
    ...
    def test_create_validation(self):
        request, response = app.test_client.post(
            "/api/bins/", json={}, cookies={"session": secrets.token_hex(32)}
        )
    ...
    def test_detail(self):
        b = Bin.create(session=secrets.token_hex(32), name="random")
